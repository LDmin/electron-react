 ...
 * @return {boolean}
 */
function handleGreyUpdate(msg: { updateUrl: any }) {
...
function sendUpdateMessage(
  text: string,
  mainWindow: { webContents: { send: (arg0: string, arg1: any) => void } },
) {
...
function updateHandle(
  ...
  autoUpdater.on("update-available", function (UpdateInfo: any) {
  ...
  ipcMain.on("checkForUpdates", (e: any, msg: any) => { // 获取灰度控制信息
  ...
  if (isElectronDev && process.platform === "win32") { // windows 本地测试 admin:改为你的用户名
    // win 本地安装包路径
    localresourcePath =
      `C:/Users/admin/AppData/Local/Programs/YOURAPP/resources/app`;
    resourcePath = `C:/Users/admin/AppData/Local/Programs/YOURAPP/resources`;
    appZipPath =
      `C:/Users/admin/AppData/Local/Programs/YOURAPP/resources/app.zip`;
  }
  ...
  // 增量更新
  ipcMain.on("checkForPartUpdates", async (e: any, msg: any) => {
